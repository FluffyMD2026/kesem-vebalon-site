...
write_category "home-designs" "עיצובים עד הבית" "Images/Gallery/home-designs"
printf ',\n' >> "$temporary"
write_category "room-designs" "עיצובי חדרים" "Images/Gallery/room-designs"
printf ',\n' >> "$temporary"
write_category "organic-walls-arches" "אורגני/קירות/קשתות" "Images/Gallery/organic-walls-arches"
printf ',\n' >> "$temporary"
